            ...
            <div class="card">
                ...
                <div class="card-header">
                    <div class="card-title">
                        <button type="button" onclick="window.location.href='{{route('user.taskList')}}'" class="btn btn-default btn-sm">Reset</button>
                    </div>
                            ...
                            <?php $i = 1;?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('user.delete.task',$task->id)}}" class="text-danger w-4 h-4 mr-1">
