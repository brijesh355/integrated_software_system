                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="title" id="title" value="{{ old('title',$task->title ? $task->title : '') }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="due_date" id="due_date"
                                        value="{{ old('due_date',$task->due_date ? $task->due_date : '') }}" class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="status" name="status">
                                        ...
                                        <option value="{{$task->status}}" @if ($task->status == 'Inprogress') {{ 'selected' }} @endif>
                                            {{"Inprogress"}}</option>
